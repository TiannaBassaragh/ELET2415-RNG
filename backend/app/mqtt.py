...
class MQTT:
    ...
    sub_topics = [("620162297_pub", 0), ("620162297", 0), ("620162297", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
...
#     publish("620162297_sub", "messages")
#     pass